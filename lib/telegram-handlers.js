  ...
  handleTailor: async (chatId, userId, input, h) => {
    try {
      ...
      if (input.match(/^https?:\/\//)) {
        ...
        // Try to get some context from the title if available
        if (scraped.title) {
      ...
      // Generate downloadable PDF and Word formats
      await h.send(chatId, `📄 Generating ATS-friendly PDF and Word documents...`);
